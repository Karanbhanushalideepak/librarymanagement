...
<div id="main">
  ...
  <div class="container">
    ...
    <form class="Approve" action="" method="post">
        ...
        <input type="date" min="2023-10-26" name="issue" placeholder="Issue Date yyyy-mm-dd" required="" class="form-control"><br>

        <input type="date" min="2023-10-26" name="return" placeholder="Return Date yyyy-mm-dd" required="" class="form-control"><br>
...
<?php
  if(isset($_POST['submit']))
  {
    ...
    mysqli_query($db,"UPDATE books SET quantity = quantity-1 where bid='$_SESSION[bid]' echo $total > 0 ? $total : 0;");
