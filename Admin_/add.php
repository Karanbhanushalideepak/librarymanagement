...
<div id="main">
  ...
  <div class="container" style="text-align: center;">
    ...
    <select name="authors" class="form-control" required="">
        ...
        <?php
        // Fetch data from the author table and populate the dropdown
...
<select name="department" class="form-control" required="">
  ...
  <!-- Add more options as needed -->
        ...
        <button style="text-align: center ;color:black" class="btn btn-default" type="submit" name="submit" >ADD</button>
        <button style="text-align: center ;color:black" class="btn btn-default" type="submit" name="submit" ><a href="History.php">LAST ADDED BOOK</a></button>
        <button style="text-align: center ;color:black" class="btn btn-default" type="submit" name="submit" ><a href="books.php">BOOK LIST</a></button>
       
    <!-- <button style="text-align: center; color: black" class="btn btn-default" type="submit" name="submit">ADD</button>
    <button style="text-align: center; color: black" class="btn btn-default" type="submit" name="submit">
        <a href="History.php">LAST ADDED BOOK</a>
    </button> -->
<!-- </form>
